...
```{r message=FALSE, warning=FALSE}
# import data
tab <- read_xlsx(here("../AnonData/S1_Data.xlsx")) %>%
  remove_empty()
...
chart <- read_xlsx(here("../AnonData/S2_Data.xlsx")) %>%
  remove_empty()
...
rtd <- read.csv(here("../AnonData/S3_Data.csv")) %>%
  remove_empty()
...
comments <- read_xlsx(here("../AnonData/S2_Data.xlsx"), sheet = 2)
#comments <- comments %>%
#  mutate(
